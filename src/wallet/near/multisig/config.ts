/** near-connect sandbox wallet id for Trezu (SputnikDAO). */
export const TREZU_CONNECTOR_ID = "trezu-wallet";
...
export const TREZU_NOT_CONNECTED_MESSAGE = "Connect a Near wallet to send this payout";
export const TREZU_PROPOSAL_DISCOVER_TIMEOUT_MESSAGE =
  "Timed out waiting for the Trezu proposal to appear on-chain";
