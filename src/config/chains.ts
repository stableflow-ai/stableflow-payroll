...
export const FIXED_CHAINS: ChainConfig[] = [
  { blockchain: "eth", chainName: "Ethereum", chainKind: "evm", chainId: 1, logo: chainLogoUrl("eth"), payerEnabled: true, txExplorer: "https://etherscan.io/tx/" },
  { blockchain: "base", chainName: "Base", chainKind: "evm", chainId: 8453, logo: chainLogoUrl("base"), payerEnabled: true, txExplorer: "https://basescan.org/tx/" },
  { blockchain: "arb", chainName: "Arbitrum", chainKind: "evm", chainId: 42161, logo: chainLogoUrl("arb"), payerEnabled: true, txExplorer: "https://arbiscan.io/tx/" },
  { blockchain: "op", chainName: "Optimism", chainKind: "evm", chainId: 10, logo: chainLogoUrl("op"), payerEnabled: true, txExplorer: "https://optimistic.etherscan.io/tx/" },
  { blockchain: "pol", chainName: "Polygon", chainKind: "evm", chainId: 137, logo: chainLogoUrl("pol"), payerEnabled: true, txExplorer: "https://polygonscan.com/tx/" },
  { blockchain: "bsc", chainName: "BNB Chain", chainKind: "evm", chainId: 56, logo: chainLogoUrl("bsc"), payerEnabled: true, txExplorer: "https://bscscan.com/tx/" },
  { blockchain: "avax", chainName: "Avalanche", chainKind: "evm", chainId: 43114, logo: chainLogoUrl("avax"), payerEnabled: true, txExplorer: "https://snowscan.xyz/tx/" },
  { blockchain: "gnosis", chainName: "Gnosis", chainKind: "evm", chainId: 100, logo: chainLogoUrl("gnosis"), payerEnabled: true, txExplorer: "https://gnosisscan.io/tx/" },
  { blockchain: "monad", chainName: "Monad", chainKind: "evm", chainId: 143, logo: chainLogoUrl("monad"), payerEnabled: true, txExplorer: "https://monadvision.com/tx/" },
  { blockchain: "scroll", chainName: "Scroll", chainKind: "evm", chainId: 534352, logo: chainLogoUrl("scroll"), payerEnabled: true, txExplorer: "https://scrollscan.com/tx/" },
  { blockchain: "xlayer", chainName: "X Layer", chainKind: "evm", chainId: 196, logo: chainLogoUrl("xlayer"), payerEnabled: true, txExplorer: "https://www.okx.com/web3/explorer/xlayer/tx/" },
  { blockchain: "plasma", chainName: "Plasma", chainKind: "evm", chainId: 9745, logo: chainLogoUrl("plasma"), payerEnabled: true, txExplorer: "https://plasmascan.to/tx/" },
  { blockchain: "bera", chainName: "Berachain", chainKind: "evm", chainId: 80094, logo: chainLogoUrl("bera"), payerEnabled: true, txExplorer: "https://berascan.com/tx/" },
  { blockchain: "near", chainName: "Near", chainKind: "near", logo: chainLogoUrl("near"), payerEnabled: false, txExplorer: "https://nearblocks.io/txns/" },
  { blockchain: "sol", chainName: "Solana", chainKind: "solana", logo: chainLogoUrl("sol"), payerEnabled: false, txExplorer: "https://solscan.io/tx/" },
  { blockchain: "tron", chainName: "Tron", chainKind: "tron", logo: chainLogoUrl("tron"), payerEnabled: false, txExplorer: "https://tronscan.org/#/transaction/" },
];
