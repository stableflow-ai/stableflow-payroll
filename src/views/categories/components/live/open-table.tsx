...
function RowAction(props: {
  action: OperationOpenBatch["action"];
  batch: OperationOpenBatch;
  category: string;
  onPayNow: (form: Payable) => void;
}) {
  const { action, batch, category, onPayNow } = props;
  ...
  const form = operationBatchToPayable(batch, category);
...
function OperationBatchBlock(props: {
  batch: OperationOpenBatch;
  category: string;
  onPayNow: (form: Payable) => void;
}) {
...
export function OperationOpenTable(props: {
