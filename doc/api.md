...
| Method | Path | Auth | Body / Query | Data | API | Hook |
| --- | --- | --- | --- | --- | --- | --- |
| POST | `/v1/payroll/payouts/submit` | yes | `PayBatchSubmitParam` (`quote_id`, `quote_batch_id`, `tx_hash`) | `PayrollPayoutSubmitResult` | `batchSubmit` | via `batch-payout-commit-queue` |
