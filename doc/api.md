...
| POST | `/v1/payroll/expenses/{batch_id}/pay/quote` | yes | `PayablePayBaseParam` | `PayablePayQuote` | `payExpenseBatch` | `usePayablePayQuery` |
| POST | `/v1/payroll/bonuses/{batch_id}/pay/quote` | yes | `PayablePayBaseParam` | `PayablePayQuote` | `payBonusBatch` | `usePayablePayQuery` |
